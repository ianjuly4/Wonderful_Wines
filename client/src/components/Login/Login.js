...
function Login() {
  ...
  return (
    <div className="flex flex-col items-center p-6 rounded-lg shadow-lg w-full max-w-md">
      <h2 className="text-2xl font-semibold mb-6 text-center"> Login</h2> {/* Header */}
      ...
      <form onSubmit={formik.handleSubmit} className="w-full">
        ...
        <div className="mb-4">
          ...
          {formik.touched.username && formik.errors.username && (
            <div className="text-black mt-1 text-sm">{formik.errors.username}</div>
          )}
        </div>
        ...
        <div className="mb-4">
          ...
          {formik.touched.password && formik.errors.password && (
            <div className="text-black mt-1 text-sm">{formik.errors.password}</div>
          )}
        </div>
